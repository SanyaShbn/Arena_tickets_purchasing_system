...
public class AdminMatchesWindowController implements Initializable {
    ...
    @FXML
    private void delMatch(ActionEvent event) {
        // try{
        // Match match = (Match) table.getSelectionModel().getSelectedItem();
        // String sql = "delete from movie where id=" + match.getIdOfMatch();
    ...
    public static class Match{
        ...
        public void setIdOFMatch(int id){
            this.id.set(id);
        }
        ...
        public String getMatchType() {return type.get();}
