...
public class AdminTicketsController implements Initializable {
    ...
    public void loadFromDataBase() throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement prStr = new DatabaseHandler().getDbConnectionForAdminTickets().prepareStatement(select);
    ...
    private void delTicketsFromTable(ActionEvent event) {
        try{
            ...
            PreparedStatement prStr = new DatabaseHandler().getDbConnectionForAdminTickets().prepareStatement(delete);
            prStr.executeUpdate();
            //if(все успешно){
